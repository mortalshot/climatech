(() => {
    ...
    function formQuantity() {
        document.addEventListener("click", (function(e) {
            ...
            if (targetElement.closest("[data-quantity-plus]") || targetElement.closest("[data-quantity-minus]")) {
                ...
                if ("template8-quantity" == valueElement.id) {
                    const template8QuantityLabels = document.querySelectorAll(".template8-quantity");
                    template8QuantityLabels.forEach((element => {
                        element.innerHTML = valueElement.value;
                    }));
                }
            }
        }));
    ...
    function initSliders() {
        if (document.querySelector(".template4__slider")) new core(".template4__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".template4 .swiper-pagination",
                type: "fraction"
            },
            navigation: {
        ...
        if (document.querySelector(".template9__slider")) new core(".template9__slider", {
            modules: [],
            observer: true,
            observeParents: true,
            watchOverflow: true,
    ...
    if (input.length > 0) {
        input.forEach((item => {
            ...
            item.addEventListener("blur", (function() {
                ...
                if (item.classList.contains("wpcf7-not-valid")) itemParent.classList.add("_invalid"); else itemParent.classList.remove("_invalid");
            }));
        }));
    ...
    if (template8Func1) template8Func1.addEventListener("change", (function() {
        if (template8Func1.checked) template8Func1Labels.forEach((element => {
            element.innerHTML = "Да";
        })); else template8Func1Labels.forEach((element => {
    ...
    if (template8Func2) template8Func2.addEventListener("change", (function() {
        if (template8Func2.checked) template8Func2Labels.forEach((element => {
            element.innerHTML = "Да";
        })); else template8Func2Labels.forEach((element => {
            element.innerHTML = "Нет";
        }));
    }));
